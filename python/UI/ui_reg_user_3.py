...
class Ui_RegisterReader(object):
    ...
    def retranslateUi(self, RegisterReader):
        ...
        RegisterReader.setWindowTitle(_translate("RegisterReader", "Зарег. пользователя"))
        self.surname.setText(_translate("RegisterReader", "Фамилия"))
        self.lineEdit_sName.setToolTip(_translate("RegisterReader", "<html><head/><body><p><span style=\" font-size:8pt;\">Введите фамилию пользователя (ученика)</span></p></body></html>"))
        self.first_name.setText(_translate("RegisterReader", "Имя"))
        self.lineEdit_fName.setToolTip(_translate("RegisterReader", "<html><head/><body><p><span style=\" font-size:8pt;\">Введите имя пользователя (ученика)</span></p></body></html>"))
        self.p_name.setText(_translate("RegisterReader", "Отчество"))
        self.lineEdit_pName.setToolTip(_translate("RegisterReader", "<html><head/><body><p><span style=\" font-size:8pt;\">Введите отчество пользователя (ученика)</span></p></body></html>"))
